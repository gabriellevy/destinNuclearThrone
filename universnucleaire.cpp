...
void UniversNucleaire::GenererCaracs()
{
    ...
    m_Histoire->m_Caracs.append(new Carac(Run::arme1, "Arme 1", "revolver", "", "", MODE_AFFICHAGE::ma_Img));
    m_Histoire->m_Caracs.append(new Carac(Run::arme2, "Arme 2", "", "", "", MODE_AFFICHAGE::ma_Img));
    ...
    /// munitions
    m_Histoire->m_Caracs.append(new Carac(Run::balles, "Balles", "96", "", "", MODE_AFFICHAGE::ma_Img));
    m_Histoire->m_Caracs.append(new Carac(Run::cartouches, "Cartouches", "0", "", "", MODE_AFFICHAGE::ma_Img));
    m_Histoire->m_Caracs.append(new Carac(Run::carreaux, "Carreaux", "0", "", "", MODE_AFFICHAGE::ma_Img));
    m_Histoire->m_Caracs.append(new Carac(Run::explosifs, "Explosifs", "0", "", "", MODE_AFFICHAGE::ma_Img));
    m_Histoire->m_Caracs.append(new Carac(Run::energie, "Énergie", "0", "", "", MODE_AFFICHAGE::ma_Img));
}
